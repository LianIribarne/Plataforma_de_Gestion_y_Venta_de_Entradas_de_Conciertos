...
class Command(BaseCommand):
    def handle(self, *args, **options):
        if Concierto.objects.filter(titulo="AURORA – What Happened To The Earth? Tour | Buenos Aires").exists():
            self.stdout.write("El concierto ya existe")
            return
        ...
        with transaction.atomic():
            ...
            concierto.save(update_fields=["iniciar_task_id", "finalizar_task_id"])
            ...
            self.stdout.write(self.style.SUCCESS("Concierto creado correctamente"))
