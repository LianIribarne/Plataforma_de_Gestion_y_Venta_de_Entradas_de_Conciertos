...
export default function CrearArtista({ isOpen, onClose, id }) {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      pais_origen: artista[0].pais_origen.id,
      imagen: artista[0].imagen
    })

    setPreview(artista[0].imagen)
  }, [artista])
  ...
  return (
    <Modal isCentered isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent bg="whiteAlpha.500" borderRadius="20px" minW='800px'>
        <ModalHeader color="white">Modificar Artista</ModalHeader>
