      ...
      <ModalContent borderRadius={30} bg='whiteAlpha.500'>
        ...
        <ModalBody align='center' color="white">
          <Box mb={3}>
            ...
            <Box as='span' ml={3} fontSize='lg'><b>{user.email}</b></Box>
          </Box>
          <Box mb={3}>
            <Text as='span'>Fecha de nacimiento</Text>
            <Box as='span' ml={3} fontSize='lg'><b>{user.fecha_nacimiento}</b></Box>
          </Box>
          <Box mb={3}>
            <Text as='span'>Género</Text>
            <Box as='span' ml={3} fontSize='lg'><b>{user.genero}</b></Box>
          </Box>
        </ModalBody>
        <ModalFooter>
          <Button
